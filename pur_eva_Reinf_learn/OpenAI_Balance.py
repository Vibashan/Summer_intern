...
LR = 1e-3 #Learning rate can be tweeked accord to envi
env = gym.make("CartPole-v0")
env.reset()
goal_steps = 500 		#500 frames its balance the pole then it +1 to the score
score_requirement = 50  #Random games of score more than 50 > Learn
initial_games = 10000 	#If we increase it we brute force the learning(not req)
