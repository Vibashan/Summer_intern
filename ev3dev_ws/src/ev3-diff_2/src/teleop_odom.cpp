...
{      
    ...
    ros::Publisher odom_pub("odom_1", &odom_msg);//odom is the topic and odom_msg is the message that ev3 publishes
    ...
    while(1)
        ...
        odom_trans.header.frame_id = "odom_1";
        const char base_link_name[18] = "base_link_1";
        ...
        odom_msg.header.frame_id = "odom_1";
