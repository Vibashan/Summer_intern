...
echo_and_run cd "/home/nikes/tum_simulator_ws/src/kobuki/kobuki_testsuite"
...
echo_and_run /usr/bin/env \
    ...
    "/usr/bin/python" \
    "/home/nikes/tum_simulator_ws/src/kobuki/kobuki_testsuite/setup.py" \
    build --build-base "/home/nikes/tum_simulator_ws/build/kobuki/kobuki_testsuite" \
    install \
    $DESTDIR_ARG \
