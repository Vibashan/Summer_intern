...
echo_and_run cd "/home/nikes/tum_simulator_ws/src/kobuki_desktop/kobuki_qtestsuite"
...
echo_and_run /usr/bin/env \
    ...
    "/usr/bin/python" \
    "/home/nikes/tum_simulator_ws/src/kobuki_desktop/kobuki_qtestsuite/setup.py" \
    build --build-base "/home/nikes/tum_simulator_ws/build/kobuki_desktop/kobuki_qtestsuite" \
    install \
    $DESTDIR_ARG \
