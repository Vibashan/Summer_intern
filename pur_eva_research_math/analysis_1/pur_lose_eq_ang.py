...
while(1):
    xe_1,ye_1,xe_2,ye_2,xt,yt = 400+200*math.cos(math.radians(315)),300+200*math.sin(math.radians(315)),600,300,400,300
    xp,yp = restart() 
    if episode == 'over':
        pur_lose = (st_xp,st_yp,st_xe_1,st_ye_1,st_xe_2,st_ye_2,st_xt,st_yt,winner,0)
        file = open('pur_ana_ang_1.csv','a')
