...
def best_angle(xp,yp,xe_1,ye_1,xe_2,ye_2,xt,yt):
    ...
    for i in range(0,360):
        ...
        d_1 = (dist_eva1_1-dist_eva1_2)
        d_2 = (dist_eva2_1-dist_eva2_2)
        d = (d_1+d_2)
...
while(1):
    if repeat > 0:
        xp,yp,xe_1,ye_1,xe_2,ye_2,xt,yt = st_xp,st_yp,st_xe_1,st_ye_1,st_xe_2,st_ye_2,st_xt,st_yt
        repeat-=1
        mode = 'off'
    elif repeat<=0:
        if episode == 'restart' and mode == 'on':
            print('Pursuer_wins')
        xp,yp,xe_1,ye_1,xe_2,ye_2,xt,yt = 400,300,401,110,610,189,450,230
        mode = 'on'   
    ...
    while(1):
        ...
        if xi_2<10 or xi_2>790 or yi_2<10 or yi_2>590:
            break
        if (abs(xt-xi_1)<2 and abs(yt-yi_1)<2) or (abs(xt-xi_2)<2 and abs(yt-yi_2)<2):
            print("Evader_Wins")
            print("0")
            if mode == 'on':
                repeat = 0
        ...
        if check_dom_region(xp,yp,xe_1,ye_1,xe_2,ye_2,xt,yt):
            print("Evader_Wins")
            print("00")
            if mode == 'on':
                repeat = 0
        ...
        if (abs(xp-xe_1)<=0.8 and abs(yp-ye_1)<=0.8):
            ...
            d1 = math.sqrt((xt-xp)*(xt-xp)+(yt-yp)*(yt-yp))
            d2 = math.sqrt((xt-xi)*(xt-xi)+(yt-yi)*(yt-yi))
            print (d1+d2)
            while True:
                for event in pygame.event.get():
                    if event.type == pygame.QUIT:
                ...
                if xi<10 or xi>790 or yi<10 or yi>590:
                    ...
                    break
                if episode == 'restart':
                    if check_dom_region_1(xp,yp,xe,ye,xt,yt):
                        print("Evader_Wins")
                        print("1")
                        if mode == 'on':
                            repeat = 0
