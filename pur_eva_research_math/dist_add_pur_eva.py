...
def best_angle(xp,yp,xe_1,ye_1,xe_2,ye_2,xt,yt):
    ...
    for i in range(0,360):
        ...
        d = (dist_eva1_1-dist_eva1_2)*(1/dist_eva1_1)+(dist_eva2_1-dist_eva2_2)*(1/dist_eva2_1)
        D.append(d)
...
while(1):
    xp,yp,xe_1,ye_1,xe_2,ye_2,xt,yt = (493 , 30 , 488, 102 ,358 ,315, 384 , 57)


    xi_1,yi_1 = intersec_pt(xp,yp,xe_1,ye_1)
    xi_2,yi_2 = intersec_pt(xp,yp,xe_2,ye_2)
    print(xi_1,yi_1,xi_2,yi_2,xt,yt)
    screen.fill((0, 0, 0))
    ...
    file = open('pur_lose_nor_diff.csv','a')
