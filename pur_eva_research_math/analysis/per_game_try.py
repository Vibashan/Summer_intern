...
while(1):   
    ...
    while(1):
        ...
        if episode == 'start' and ((abs(xt-xi_1)<=2 and abs(yt-yi_1)<=2) or (abs(xt-xi_2)<=2 and abs(yt-yi_2)<=2)):
            print("Evader_Wins")
            print("0")
            episode = 'over'
            break
        ...
        if (abs(xp-xe_1)<=0.8 and abs(yp-ye_1)<=0.8):
            ...
            print(xe_2,ye_2,eva1_dist_fin,eva2_dist_fin)
            ...
            while True:
                ...
                if episode == 'start' and (abs(xt-xi)<2 and abs(yt-yi)<2):
                    print("Evader_Wins")
                    print("0")
                    episode = 'over'
                    break
