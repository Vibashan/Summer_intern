...
def ml_linear(x1,x2,dist_eva1_1,dist_eva2_1,ini_dist):
    alpha = 0.0001
    fin_dist = dist_eva1_1+dist_eva2_1
    x1 = x1 - alpha*(fin_dist-ini_dist)*(fin_dist-ini_dist)*dist_eva1_1
    x2 = x2 - alpha*(fin_dist-ini_dist)*(fin_dist-ini_dist)*dist_eva2_1
    return x1,x2
...
def best_angle(xp,yp,xe_1,ye_1,xe_2,ye_2,xt,yt,x0,x1,x2):
    D = deque()
    s_1 = (ye_1-yp)/(xe_1-xp)
    ym_1 = (ye_1+yp)/2
    xm_1 = (xe_1+xp)/2
    ...
    for i in range(0,360):
        ...
        d = x1*(dist_eva1_1-dist_eva1_2)*(1/dist_eva1_1)+x2*(dist_eva2_1-dist_eva2_2)*(1/dist_eva2_1)
        D.append(d)
    ...
    return xp,yp,xe_1,ye_1,xe_2,ye_2,dist_eva1_1,dist_eva2_1
...
def dist_cal(xp,yp,xe_1,ye_1,xe_2,ye_2,xt,yt):
    xi_1,yi_1 = intersec_pt(xp,yp,xe_1,ye_1)
    xi_2,yi_2 = intersec_pt(xp,yp,xe_2,ye_2)
    dist_eva1_2 = math.sqrt((xt-xi_1)*(xt-xi_1)+(yt-yi_1)*(yt-yi_1))
    dist_eva2_2 = math.sqrt((xt-xi_2)*(xt-xi_2)+(yt-yi_2)*(yt-yi_2))
    return dist_eva1_2+dist_eva2_2
...
while(1):
    xp,yp,xe_1,ye_1,xe_2,ye_2,xt,yt = (721 , 338 ,321 ,544 ,416 ,452 ,492,  190)




    #print(xp,yp,xe_1,ye_1,xe_2,ye_2,xt,yt)
    #ini_dist = dist_cal(xp,yp,xe_1,ye_1,xe_2,ye_2,xt,yt)
    #print(ini_dist)
    ini_dist = deque()
    while(1):
        ...
        xp,yp,xe_1,ye_1,xe_2,ye_2,dist_eva1_1,dist_eva2_1 = best_angle(xp,yp,xe_1,ye_1,xe_2,ye_2,xt,yt,x0,x1,x2)  
        xi_1,yi_1 = intersec_pt(xp,yp,xe_1,ye_1)
        xi_2,yi_2 = intersec_pt(xp,yp,xe_2,ye_2)

        if (abs(xp-xe_1)<=8 and abs(yp-ye_1)<=8):
            #print(dist_eva1_1+dist_eva2_1)
            #print("#############")
            if episode == 0:
                max_ini_dist = dist_eva1_1+dist_eva2_1
                ini_dist.append(max_ini_dist)
                max_ini_dist = max_ini_dist+1
                x1,x2 = ml_linear(x1,x2,dist_eva1_1,dist_eva2_1,max_ini_dist)
                print(episode,"-",dist_eva1_1,dist_eva2_1,(dist_eva1_1+dist_eva2_1),'x1-',x1,'x2-',x2)
            else:
                ini_dist_act = dist_eva1_1+dist_eva2_1
                ini_dist.append(ini_dist_act)
                ini_dist = np.array(ini_dist)
                max_ini_dist = np.amax(ini_dist)
                max_ini_dist = max_ini_dist+1
                x1,x2 = ml_linear(x1,x2,dist_eva1_1,dist_eva2_1,max_ini_dist)
                print(episode,"-",dist_eva1_1,dist_eva2_1,(dist_eva1_1+dist_eva2_1),'x1-',x1,'x2-',x2)
            episode+=1
            ...
            while True:
                ...
                if abs(xp-xe)<=8 and abs(yp-ye)<=8:
                    break
                if xi<10 or xi>790 or yi<10 or yi>590:
                    break

                screen.fill((0, 0, 0))
                pygame.draw.circle(screen, (255,0,0), (int(xp), int(yp)),9)
                pygame.draw.circle(screen, (0,255,0), (int(xe), int(ye)),9)
                pygame.draw.circle(screen, (0,0,255), (int(xt), int(yt)),9)
                pygame.draw.circle(screen, (255,255,255), (int(xi), int(yi)),4)
                pygame.display.flip()
                clock.tick(FPS)
            break

        if (abs(xp-xe_2)<=8 and abs(yp-ye_2)<=8):
            #print(dist_eva1_1+dist_eva2_1)
            #print("#############")
            if episode == 0:
                max_ini_dist = dist_eva1_1+dist_eva2_1
                ...
                ini_dist.append(ini_dist_act)
                ini_dist = np.array(ini_dist)
                max_ini_dist = np.amax(ini_dist)+1
                x1,x2 = ml_linear(x1,x2,dist_eva1_1,dist_eva2_1,max_ini_dist)
                print(episode,"-",dist_eva1_1,dist_eva2_1,(dist_eva1_1+dist_eva2_1),'x1-',x1,'x2-',x2)
            episode+=1
        ...
        screen.fill((0, 0, 0))
        pygame.draw.circle(screen, (255,0,0), (int(xp), int(yp)),9)        #Red
        pygame.draw.circle(screen, (0,255,0), (int(xe_1), int(ye_1)),9)    #Blue
        pygame.draw.circle(screen, (0,255,255), (int(xe_2), int(ye_2)),9)  #Light_blue
        pygame.draw.circle(screen, (0,0,255), (int(xt), int(yt)),9)        #Green
